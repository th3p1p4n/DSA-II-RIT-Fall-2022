...
void display(void)
{
    ...
    //pelvis
    id = 0;
    drawBox(2.5, 3.0, rotations[id], id == selectedId);
    glPushMatrix();
    // left thigh
    id++;
    glTranslatef(-1.0, 0.0, 0.0);
    drawBox(3.0, 1.0, rotations[id], id == selectedId);
    // left calf
    id++;
    glTranslatef(0.0, -3.0, 0.0);
    drawBox(2.0, 1.0, rotations[id], id == selectedId);
    // left foot
    id++;
    glTranslatef(0.0, -2.0, 0.0);
    drawBox(1.5, 1.5, rotations[id], id == selectedId);
    // right thigh
    id++;
    glPopMatrix();
    glPushMatrix();
    ...
    drawBox(2.7, 3.5, rotations[id], id == selectedId);
    glPushMatrix();
    // neck
    id++;
    glTranslatef(0.0, 2.7, 0.0);
    drawBox(1.0, 1.0, rotations[id], id == selectedId);
    // head
    id++;
    glTranslatef(0.0, 1.0, 0.0);
    drawBox(2.0, 2.0, rotations[id], id == selectedId);
    // left upper arm
    id++;
    glPopMatrix();
    glPushMatrix();
    ...
    drawBox(1.5, 1.0, rotations[id], id == selectedId);
    // left hand
    id++;
